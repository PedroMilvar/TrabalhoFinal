      ...
      <div class="col-md-4 mb-4">
        <div class="card">
          ...
          <div class="card-body" style="max-height: 300px; overflow-y: auto;">
            ...
            <p class="card-text"><b>Ementa:</b> Elaboração de estratégias de administração e planejamento de
              ações estratégicas para o crescimento econômico e social dos órgãos administrativos.</p>
            <button class="btn btn-link like-button" style="text-decoration: none;"><i class="far fa-heart"
                id="curso1-like"></i> Favoritar</button>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 mb-4">
        <div class="card">
          ...
          <div class="card-body" style="max-height: 300px; overflow-y: auto;">
            ...
            <p class="card-text">o Curso de Ciências Contábeis busca proporcionar ao aluno sólidos
              conhecimentos em contabilidade em suas diversas especificações, tais como: Análise de
              Custos, Contabilidade Gerencial, Contabilidade Comercial, Contabilidade Industrial</p>
            <p class="card-text"><b>Carga Horária:</b> 40 horas</p>
            <p class="card-text"><b>Turno:</b> Noturno</p>
            <p class="card-text"><b>Ementa:</b> Durante a graduação, nós te guiamos por uma trilha geral,
              com todos os conhecimentos necessários para a carreira. Ao longo dessa trilha, você poderá
              escolher uma área de ênfase por meio de matérias e atividades complementares, se quiser.</p>
            <button class="btn btn-link like-button" style="text-decoration: none;"><i class="far fa-heart"
                id="curso2-like"></i> Favoritar</button>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 mb-4">
        <div class="card">
          ...
          <div class="card-body" style="max-height: 300px; overflow-y: auto;">
            ...
            <p class="card-text"><b>Ementa:</b> O curso começa de uma forma bem didática, explicando o que é
              o raciocínio lógico e mostrando que a lógica está presente em nosso cotidiano em diversas
              situações. Em seguida, passamos para a etapa de download da ferramenta, instalação e
              configurações iniciais, para, então, abordar o conteúdo mais técnico.</p>
            <button class="btn btn-link like-button" style="text-decoration: none;"><i class="far fa-heart"
                id="curso3-like"></i> Favoritar</button>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 mb-4">
        <div class="card">
          ...
          <div class="card-body" style="max-height: 300px; overflow-y: auto;">
            ...
            <p class="card-text">Arquitetura e Urbanismo é uma área do conhecimento que se dedica à
              concepção e criação de espaços habitáveis e funcionais, considerando aspectos estéticos,
              sociais, culturais, econômicos, ambientais e tecnológicos.</p>
            <p class="card-text"><b>Carga Horária:</b> 20 horas</p>
            <p class="card-text"><b>Turno:</b> Noturno</p>
            <p class="card-text"><b>Ementa:</b> História da arquitetura e suas influências, Princípios de
              design arquitetônico, Estilos arquitetônicos ao longo da históri, Elementos arquitetônicos:
              formas, linhas, espaços, texturas.</p>
            <button class="btn btn-link like-button" style="text-decoration: none;"><i class="far fa-heart"
                id="curso4-like"></i> Favoritar</button>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 mb-4">
        <div class="card">
          ...
          <div class="card-body" style="max-height: 300px; overflow-y: auto;">
            ...
            <p class="card-text"><b>Carga Horária:</b> 20 horas</p>
            <p class="card-text"><b>Turno:</b> Noturno</p>
            <p class="card-text"><b>Ementa:</b> Todo o conteúdo está em formato de vídeo HD para que siga
              exatamente o que os Chefs estão a fazer no momento. Vídeos curtos e animados, para que
              consiga saber algo de novo, mesmo entre turnos. Dos princípios básicos de segurança
              alimentar, a técnicas avançadas de cozinhas do mundo</p>
            <button class="btn btn-link like-button" style="text-decoration: none;"><i class="far fa-heart"
                id="curso5-like"></i> Favoritar</button>
          </div>
        </div>
      </div>
    </div>
